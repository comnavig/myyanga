...
class ProductCategoryController extends Controller
{
    ...
    {
		return view('admin.products.category.create-subcategory', ['cat_id' => $id]);
    }
    ...
    public function add_subcategory(Request $request)
     {
        ...
        else
		{
			...
			return redirect()->route('admin.products.category.subcategory', ['id' =>$request->parent_id]);
    ...
    public function update_subcategory(Request $request)
    {
        ...
        else
		{
				...
				session()->flash('message', 'Task was successful!');
				return redirect()->route('admin.products.category.subcategory', ['id' => $category->parent_id ]);
