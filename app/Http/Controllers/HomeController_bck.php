...
class HomeController extends Controller
{
    ...
    public function index()
    {
		...
		if(preg_match("/(android|avantgo|blackberry|bolt|boost|cricket|docomo|fone|hiptop|mini|mobi|palm|phone|pie|tablet|up\.browser|up\.link|webos|wos)/i", $_SERVER["HTTP_USER_AGENT"])) {
		    return view('welcome-old', ['featuredcategories' => $featuredcategories, 'products' => $products ]); exit;
		}
    ...
    foreach ($users as $user) {
        ...
        if (!empty($premium_subs->id)) {
            if (!$premium_subs->daysOver($premium_subs->expiry)) {
                ...
                $premiumIds = Premium::where('created_at', '>=', $sixMonthsAgo)
