...
@section('title', 'Discover Categories')
@section('page.title', 'Discover Categories')
@section('content')
<div class="container mt-2">
	<div class="my-4">
		<h3 class="main-color">
			All Categories
			<a class="btn btn-sm warm-blue-bg float-right" href="{{route('admin.discover.category.new')}}">add new</a>
		</h3>
	</div>
