...
-->
			...
			<div class="form-group">
				...
				<input type="number" name="expiry_date" class="form-control" id="expiry_dates" value="{{ $data->expiry_dates }}" aria-describedby="expiry_dateHelp" />
				<small id="expiry_dateHelp" class="form-text text-muted">Type in the number of days each content of this category are to appear before disappearing.</small>
				@error('expiry_dates')
					<span class="invalid-feedback" role="alert">
						<strong>{{ $message }}</strong>
					</span>
