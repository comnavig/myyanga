...
<div class="container mt-2">
	<div class="my-4">
		<h3 class="main-color">
			Form
			<a class="btn btn-sm main-btn-bg float-right" href="{{route('admin.listings')}}">back to listings</a>
		</h3>
	</div>
	<div class="col-12 m-0 p-0">
		<form method="post" action="{{route('admin.listings.update')}}"  enctype="multipart/form-data" >
			@csrf
