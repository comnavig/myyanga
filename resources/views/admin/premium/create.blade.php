...
@section('page.title', 'Create Premium')
@section('content')
<div class="container mt-2">
	<div class="my-4">
		<h3 class="main-color">
			Form
			<a class="btn btn-sm main-btn-bg float-right" href="{{route('admin.premia')}}">back to Premiums</a>
		</h3>
	</div>
	<div class="col-12">
		<form method="post" action="{{route('admin.premium.add')}}"  enctype="multipart/form-data" >
			@csrf
			<div class="row">
