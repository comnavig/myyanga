...
@section('title', 'Edit Post Your Look')
...
<div class="container mt-2">
	...
	<div class="col-12">
		<form method="post" action="{{route('admin.pyl.update')}}"  enctype="multipart/form-data" >
			@csrf
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 mt-2">
					<div class="form-group">
						...
						<input type="text" name="name" class="form-control" id="name" value="{{$pyl->name}}" aria-describedby="nameHelp" required />
		<!--
		...
		-->
				...
				<div class="col-md-12 col-sm-12 mt-2">
					<div class="form-group">
						...
						<textarea name="description" class="form-control" id="description" aria-describedby="descriptionHelp" rows="12" required >{{$pyl->description}}</textarea>
						<small id="descriptionHelp" class="form-text text-muted">Please write pyl content.</small>
						@error('description')
				...
				<div class="col-md-12 col-sm-12 mt-2">
					<div class="form-group">
						...
						<input type="text" name="expired_at" class="form-control datepicker" id="expired_at" value="{{ $pyl->expired_at }}" aria-describedby="expired_atHelp" required />
		<!--
