@extends('layouts.app')
@section('title', 'Affiliate Form')
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8" style="margin-top: 10%;">
            <div class="card">
                <div class="card-header green-bg">{{ __('Register') }}</div>
                    ...
                    <form method="POST" action="{{ route('affiliate.register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn green-bg">
                                    {{ __('Register') }}
                                </button>
                                
                                <a class="btn btn-link green" href="{{ route('login') }}">
									Already Registered
								</a>
                            </div>
                        </div>
