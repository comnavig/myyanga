		...
		<div class="col-12 p-0" style="overflow-y: auto; margin-bottom: 20px;">
			<div class="container py-2 gold">
				<div class="col-md-12 col-sm-12 p-0">
					...
					@endauth
					@guest
						<a  class="btn main-color-bg rounded-0" href="{{route('login', ['redirect' => route('premiums') ] )}}">
							View Premium
						</a>
					@endguest
				</div>
			...
			<div class="container">
				<div id="" class="adts owl-carousel" data-items="1">
						@foreach($ads as $ad)
							...
							<div>
								<a href="{{ $ad['url'] }}">
									<img class="d-none d-sm-none d-lg-block" src="{{ str_replace("https://myyanga.fra1.digitaloceanspaces.com/", "https://myyanga.com/storage/", $photo['desktop']) }}" alt="{{ $ad['name'] }}"  />
