<div class="collapse" id="exploreMenu">
    <div class="position-fixed dark-grey-bg" style="width: 100%; height: 100vh; top: 0; overflow-y: auto; z-index: 99999999999;">
                ...
                <div class="col-12">
                    <div class="container py-2 gold">
                        <div class="col-12 p-0">
                            ...
                            @auth
                                <a class="btn btn-sm main-color-bg rounded-0" href="{{ route('premiums') }}">View Premium</a>
                            @endauth
                            @guest
                                <a class="btn btn-sm main-color-bg rounded-0" href="{{ route('login', ['redirect' => route('premiums')]) }}">View Premium</a>
                            @endguest
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div id="adCarousel" class="owl-carousel owl-theme">
                            @foreach($ads as $ad)
                                ...
                                <div class="item">
                                    <a href="{{ $ad['url'] }}">
                                        <img class="d-none d-lg-block img-fluid" src="{{ str_replace('https://myyanga.fra1.digitaloceanspaces.com/', 'https://myyanga.com/storage/', $photo['desktop']) }}" alt="{{ $ad['name'] }}" />
                                        <img class="d-block d-lg-none img-fluid" src="{{ str_replace('https://myyanga.fra1.digitaloceanspaces.com/', 'https://myyanga.com/storage/', $photo['mobile']) }}" alt="{{ $ad['name'] }}" />
                                    </a>
                                </div>
                            @endforeach
                        </div>
            ...
            <footer class="col-12 d-block d-sm-block d-lg-none text-center py-4" style="font-size: 14px;">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <p class="white">
                                Powered by <a class="gold btn-link" href="http://www.zonicme.com" target="_blank">ZonicMe</a> 
                        ...
                        <div class="col-12">
                            <a class="btn btn-md gold" href="https://www.facebook.com/MyYangaAfrica/?ref=pages_you_manage"><i class="bi bi-facebook"></i></a>
                            <a class="btn btn-md gold" href="https://www.instagram.com/officialmyyanga_/"><i class="bi bi-instagram"></i></a>
                            <a class="btn btn-md gold" href="https://www.linkedin.com/in/myyanga-africa-1083a012b/"><i class="bi bi-linkedin"></i></a>
                        </div>
                    </div>
                </div>
            </footer>
