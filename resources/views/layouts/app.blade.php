...
<nav class="navbar navbar-expand-md bg-light navbar-light">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
	...
	<ul class="navbar-nav text-uppercase ml-auto">
						...
						{{-- </form> --}}
						<li class="nav-item">
							<a class="nav-link gold " href="{{ route('home') }}"><i class="fa-sharp fa-solid fa-house"></i> Home</a>
						</li>
						

						<li class="nav-item">
							<a class="nav-link gold " data-toggle="collapse" href="#exploreMenu" role="button" aria-expanded="false" aria-controls="exploreMenu"><i class="fa-solid fa-door-open"></i> Explore</a>
						</li>

						<li class="nav-item">
							<a class="nav-link gold " href="{{ route('shop') }}"><i class="fa-solid fa-cart-shopping"></i> Shop</a>
						</li>
						...
						@guest
							<li class="nav-item">
								<a class="nav-link gold " href="{{ route('register') }}"><b><i class="fa-solid fa-user-plus"></i> Sign-up</b></a>
							</li>
							<li class="nav-item">
								<a class="nav-link gold " href="{{ route('login') }}"><b><i class="fa-solid fa-user-large"></i> Login</b></a>
							</li>
						@endguest
...
<div class="fixed-bottom d-block d-sm-block d-lg-none white-bg mobile-menu max-mod-mobile-menu">
	<div class=" py-3 main-color-bg" >
		<ul class="nav d-flex justify-content-around text-uppercase">
			<li class="nav-item">
				<a class="nav-link gold font-weight-bolder" href="{{route('tour')}}">Tour</a>
			</li>
			<li class="nav-item">
