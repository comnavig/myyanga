                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <!-- Authentication Links -->
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('business') }}"><i class="bi bi-speedometer2"></i> Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('listings') }}"><i class="bi bi-briefcase-fill"></i> My Brand Listings</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('products.sold') }}"><i class="bi bi-graph-up"></i> Sales</a>
                            </li>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form-business').submit();">
                                        {{ __('Logout') }}
                                    </a>
